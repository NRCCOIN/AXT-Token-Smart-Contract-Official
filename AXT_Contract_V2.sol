/**
 *Submitted for verification at BscScan.com on 2025-06-23
*/
    ...
    Ownable
{
    ...
    constructor() {
        ...
        rewardTokens.push(address(0x55d398326f99059fF775485246999027B3197955)); // USDT - 0x55d398326f99059fF775485246999027B3197955 //mainnet
        // rewardTokens.push(address(0x64544969ed7EBf5f083679233325356EbE738930)); //testnet
...
contract AXIOMATOKEN is ERC20, Ownable, Pausable {
    ...
    constructor() ERC20("AXIOMA TOKEN ", "AXT") {
        ...
        marketingWallet = address(0xc5736a0D0663e5E5935686D15a4d2B79a7e0eBB1); // set as marketing wallet mainnet
        // marketingWallet = address(0xAe18A9deDA9163bBd53984668952875FfB9abBbD); // set as marketing wallet testnet
    ...
    function updateMarketingWalletWallet(address newMarketingWalletWallet)
        external
        onlyOwner
    {
        require(
            newMarketingWalletWallet != address(0),
            "may not set to 0 address"
        );
